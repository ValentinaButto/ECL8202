...
Si on veut voir comment le tout pourrait marcher sur R on peut commencer par générer un échantillon de 100 données à partir d'une distribution normale avec une moyenne de 3 et un écart-type de 2.
